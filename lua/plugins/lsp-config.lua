return {
	...
	old_config = function()
		...
		local servers = { "autotools_ls", "clangd", "lua_ls", "pyright", "texlab" }
		...
		vim.api.nvim_create_autocmd("LspAttach", {
			...
			callback = function(ev)
				...
				vim.keymap.set(
					...
					{ buffer = ev.buf, desc = "LSP go to definition/implementation" }
				)
				...
				vim.keymap.set("n", "gr", vim.lsp.buf.references, { buffer = ev.buf, desc = "LSP view references" })
